...
def apply_2d_zoom_3d(arr3d, spacing, new_spacing, order=1, do_blur=True, as_type=np.float32):
    ...
    :param arr3d: [#slices, y, x]
    :param spacing: spacing has shape [#slices, y, x]
    :param new_spacing: tuple(y, x) if you pass more than 2 dimensions than only last 2 are used
    :param order: of B-spline (use 0 for integer labels)
